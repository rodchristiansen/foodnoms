...
| [003](docs/issues/003-edit-deleted-what-it-could-not-re-log.md) | `edit` deleted the entry and re-logged nothing — the re-log called a bridge command that was never defined | fixed |
