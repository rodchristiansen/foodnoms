...
what `foodEntryRecord.measure` holds and what `foodnoms resolve` now reports, alongside
...
record's `ZDATA`, a `crdt`-tagged protobuf; `foodnoms-bridge --folders` decodes it.
