...
**Status:** fixed · **Opened:** 2026-08-30 · **Fixed:** 2026-09-03 · **Affects:** `foodnoms delete`, `DeleteLoggedFoodIntent`

`foodnoms delete <entry-id|name>` reaches `DeleteLoggedFoodIntent` through the bridge
...
one action each — the generator in `foodnoms-bridge` currently assumes one action per
