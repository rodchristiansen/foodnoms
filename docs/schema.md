...
Notes on the Core Data store FoodNoms reads. This is reverse-engineered from the shipping
...
in the write-ahead log; copying the `.sqlite` alone returns stale data. FoodNoms copies all
