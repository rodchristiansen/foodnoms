...
```bash
foodnoms delete "Cold brew"
foodnoms delete "Cold brew" --on 2026-09-03
foodnoms delete A34941A0-5D04-4BDE-96B8-7CEF8D04639D --on 2026-09-03
foodnoms delete "Cold brew" --on 2026-09-03 --all
```
...
```bash
foodnoms edit "Cold brew" --calories 20
foodnoms edit "Cold brew" --scale 0.5
foodnoms edit "Cold brew" --to 2026-09-04
```
...
```bash
foodnoms day 2026-09-03 --json | jq -r '.entries[].name' | sort | uniq -c | sort -rn | head
```
