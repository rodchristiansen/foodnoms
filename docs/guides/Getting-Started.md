...
`foodnoms` imports only the Python standard library and needs 3.10 or newer.
...
foodnoms doctor
  ...
  [OK]   55 saved meals
  [OK]   write path: "FoodNoms Bridge" installed
```
...
`foodnoms` needs Full Disk Access. That is your terminal, or whatever host runs your agent,
