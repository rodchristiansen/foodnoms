...
foodnoms log-weight 191.4
foodnoms create-food "House Granola" --brand "Homemade" --calories 220 --protein 6
foodnoms db-search "skyr"
foodnoms ask "how much protein have I had today"
foodnoms goal
```
...
reads that `foodnoms` already answers faster and in more detail from the store — wrapping
`GetFoodEntriesIntent` would be strictly worse than `foodnoms day`. So the manifest carries
