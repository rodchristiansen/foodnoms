...
Twelve of them, in the [wiki](https://github.com/rodchristiansen/foodnoms/wiki) — getting
started, [what runs unattended](https://github.com/rodchristiansen/foodnoms/wiki/What-Runs-Unattended),
reading the library, writing, the queue, correcting the log, the bridge Shortcut,
[troubleshooting](https://github.com/rodchristiansen/foodnoms/wiki/Troubleshooting), how it
